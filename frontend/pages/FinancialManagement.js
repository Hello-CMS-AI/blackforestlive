...
const FinancialManagement = () => {
  ...
  const fetchBalances = async () => {
    try {
      const response = await fetch('http://139.59.82.174/api/financial/balances', {
        method: 'GET',
  ...
  const fetchTransactions = async () => {
    try {
      const response = await fetch('http://139.59.82.174/api/financial/transactions', {
        method: 'GET',
        headers: { 'Content-Type': 'application/json' },
      });
      const result = await response.json();
  ...
  const handleDeposit = async (values) => {
    ...
    try {
      const response = await fetch('http://139.59.82.174/api/financial/deposit', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleExpense = async (values) => {
    ...
    try {
      const response = await fetch('http://139.59.82.174/api/financial/expense', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
