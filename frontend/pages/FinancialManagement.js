...
const FinancialManagement = () => {
  ...
  const fetchBalances = async () => {
    try {
      const response = await fetch('https://api10.theblackforestcakes.com/api/financial/balances', {
        method: 'GET',
  ...
  const fetchTransactions = async () => {
    try {
      const response = await fetch('https://api10.theblackforestcakes.com/api/financial/transactions', {
        method: 'GET',
        headers: { 'Content-Type': 'application/json' },
      });
      const result = await response.json();
  ...
  const handleDeposit = async (values) => {
    ...
    try {
      const response = await fetch('https://api10.theblackforestcakes.com/api/financial/deposit', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleExpense = async (values) => {
    ...
    try {
      const response = await fetch('https://api10.theblackforestcakes.com/api/financial/expense', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
