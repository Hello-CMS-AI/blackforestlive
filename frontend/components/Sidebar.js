...
const menuItems = [
  ...
  { key: "delivery", label: "Dealer", icon: <DeliveredProcedureOutlined />, path: "/dealers/account" },
  { key: "payments", label: "Payments", icon: <CreditCardOutlined />, path: "/FinancialManagement", newTab: true },
